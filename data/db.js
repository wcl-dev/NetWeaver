  ...
  "entities": [
    ...
    },
    {
      ...
      "indicators": [
        ...
        "Google GLASSBRIDGE 移除逾 600 個與海訊相關的域名",
    ...
    },
    {
      ...
      "indicators": [
        "Meta 2023-08 下架 7,704個FB帳號、954個粉專、15個社團、15個IG帳號 (Meta，經 Record 引述)",
        "跨逾50個應用程式/平台 (Meta)",
        "Google 2024 Q1 移除逾1萬個 DRAGONBRIDGE 活動實例",
        "操作語言數：逾 20 種語言（2025）",
        "操作平臺數：全球逾 180 個社群平臺（2025）",
        "Meta 2023/08/29 下架：7,704 個 Facebook 帳號、954 個粉專、15 個社團、15 個 Instagram 帳號（史上最大）",
        "活躍於超過 50 個平台與論壇",
        "Google：2022 全年瓦解逾 50,000 次活動、停用 53,177 個 YouTube 頻道；2024 Q1 逾 10,000 次",
        "針對台灣 2024 大選散布 318 頁《蔡英文秘史》偽文件",
        "#taiwan #america 等通用標籤"
      ],
